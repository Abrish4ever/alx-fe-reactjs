function UserProfile() {
    return (
      <div className="user-profile bg-gray-100 p-8 max-w-xs mx-auto my-20 rounded-lg shadow-lg sm:p-4 md:max-w-sm md:p-8 hover:shadow-xl">
            ...
            <h1 className="text-xl text-blue-800 my-4 sm:text-lg sm:my-2 md:text-xl md:my-4 hover:text-blue-500">John Doe</h1>
